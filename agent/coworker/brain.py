        ...
        if _CD in self._caps:
            parts.append(
                ...
                + ("\n- O'chirish/yuborish kabi tugmalarda tizim tasdiq so'raydi —\n"
                   ...
                   "\nDASTURGA BUYRUQ BERISH (Claude Code, Antigravity, Cursor, VS\n"
                   "Code, terminal, AI chat ilovalari) — ILOVANI BOSHQARISH namunasi:\n"
                   "  1. `list_windows` bilan oynani top. AGAR RO'YXATDA BO'LSA —\n"
                   "     u OCHIQ, «yopiq» yoki «yo'q» DEMA! Yopiq bo'lsa `open_app`.\n"
                   "  2. `key_type` bilan buyruq matnini yoz (handle ber). Bu\n"
                   "     ILOVANING kiritish maydoniga tushadi — Antigravity/VS Code\n"
                   "     kabi Electron ilovalarda ham ISHLAYDI.\n"
                   "  3. `key_press` `enter` bilan yubor.\n"
                   "  4. Bir-ikki soniya kut, `screen_read` bilan SHU oynani o'qi\n"
                   "     (handle ber!) — javobni ko'rib foydalanuvchiga ayt.\n"
                   "  5. Javob uzun/oqib kelayotgan bo'lsa — kutib qayta `screen_read`.\n"
                   "\nMUHIM: `read_window` Electron/Qt ilovalarda (Antigravity, VS\n"
                   "Code, Cursor, terminal) KAM yoki BO'SH element qaytaradi — bu\n"
                   "NORMAL, ilova yopiq degani EMAS. U holda tugma raqamlarini\n"
                   "kutma: to'g'ridan-to'g'ri `key_type`+`enter` (handle bilan) ishlat\n"
                   "va `screen_read` bilan o'qi. Terminal matnini faqat `screen_read`\n"
                   "(vision) o'qiydi, UIA emas."
